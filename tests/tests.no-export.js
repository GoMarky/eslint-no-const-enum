...
var linterOptions = {
	...
	paramsUnusedAllDefault: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{count: 1000,length:0,trivial:true,},], },
	},
	paramsUnusedAll: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{unused:"all",count:1000,length:0,trivial:true,},], },
	},
	paramsUnusedTrailing: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{unused:"trailing",count:1000,length:0,trivial:true,},], },
	},
	paramsUnusedNone: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{unused:"none",count:1000,length:0,trivial:true,},], },
	},
	paramsCountDefault: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{unused:"none",length:0,trivial:true,},], },
	},
	paramsCount0: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{unused:"none",count:0,length:0,trivial:true,},], },
	},
	paramsLengthDefault: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{unused:"none",count:1000,trivial:true,},], },
	},
	paramsLength1: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{unused:"none",count:1000,length:1,trivial:true,},], },
	},
	paramsAllowed: {
		parserOptions: { ecmaVersion: 2015, },
		rules: { "@gomarky/no-const-enum/no-export": ["error",{allowed:[],trivial:true,},], },
	},
};
...
QUnit.test( "PARAMS (default): violating", function test(assert){
	...
	assert.strictEqual( ruleId1, "@gomarky/no-const-enum/no-export", "ruleId1" );
	assert.strictEqual( messageId1, "tooShort", "messageId1" );
	assert.strictEqual( ruleId2, "@gomarky/no-const-enum/no-export", "ruleId2" );
	assert.strictEqual( messageId2, "unused", "messageId2" );
	assert.strictEqual( ruleId3, "@gomarky/no-const-enum/no-export", "ruleId3" );
	assert.strictEqual( messageId3, "tooShort", "messageId3" );
	assert.strictEqual( ruleId4, "@gomarky/no-const-enum/no-export", "ruleId4" );
	assert.strictEqual( messageId4, "tooShort", "messageId4" );
	assert.strictEqual( ruleId5, "@gomarky/no-const-enum/no-export", "ruleId5" );
	assert.strictEqual( messageId5, "tooMany", "messageId5" );
	assert.strictEqual( ruleId6, "@gomarky/no-const-enum/no-export", "ruleId6" );
	assert.strictEqual( messageId6, "tooShort", "messageId6" );
	assert.strictEqual( ruleId7, "@gomarky/no-const-enum/no-export", "ruleId7" );
...
QUnit.test( "PARAMS (unused: all): violating | nesting, shadowing", function test(assert){
	...
	assert.strictEqual( ruleId8, "@gomarky/no-const-enum/no-export", "ruleId8" );
	assert.strictEqual( messageId8, "unused", "messageId8" );
	assert.ok( message8.includes("`s`"), "message8" );
	assert.strictEqual( ruleId9, "@gomarky/no-const-enum/no-export", "ruleId9" );
	assert.strictEqual( messageId9, "unused", "messageId9" );
	assert.ok( message9.includes("`d`"), "message9" );
	assert.strictEqual( ruleId10, "@gomarky/no-const-enum/no-export", "ruleId10" );
...
QUnit.test( "PARAMS (count: 3, default): violating", function test(assert){
	...
	assert.strictEqual( ruleId, "@gomarky/no-const-enum/no-export", "ruleId" );
...
QUnit.test( "PARAMS (allowed, defaults): conforming", function test(assert){
	...
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["x","y","z","w",];
...
QUnit.test( "PARAMS (allowed, defaults): violating", function test(assert){
	...
	var config = copyObj(linterOptions.paramsAllowed);
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["x","z",];
...
QUnit.test( "PARAMS (allowed, unused:all): conforming", function test(assert){
	...
	var config = copyObj(linterOptions.paramsAllowed);
	config.rules["@gomarky/no-const-enum/no-export"][1].unused = "all";
	config.rules["@gomarky/no-const-enum/no-export"][1].count = 1000;
	config.rules["@gomarky/no-const-enum/no-export"][1].length = 1;
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["x","w",];
...
QUnit.test( "PARAMS (allowed, unused:all): violating", function test(assert){
	...
	config.rules["@gomarky/no-const-enum/no-export"][1].count = 1000;
	config.rules["@gomarky/no-const-enum/no-export"][1].length = 1;
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["x",];
...
QUnit.test( "PARAMS (allowed, unused:trailing): conforming", function test(assert){
	...
	var config = copyObj(linterOptions.paramsAllowed);
	config.rules["@gomarky/no-const-enum/no-export"][1].unused = "trailing";
	config.rules["@gomarky/no-const-enum/no-export"][1].count = 1000;
	config.rules["@gomarky/no-const-enum/no-export"][1].length = 1;
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["w",];
...
QUnit.test( "PARAMS (allowed, count:0): conforming", function test(assert){
	...
	var config = copyObj(linterOptions.paramsAllowed);
	config.rules["@gomarky/no-const-enum/no-export"][1].unused = "none";
	config.rules["@gomarky/no-const-enum/no-export"][1].count = 0;
	config.rules["@gomarky/no-const-enum/no-export"][1].length = 1;
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["x","y","z","w",];
...
QUnit.test( "PARAMS (allowed, count:2): conforming", function test(assert){
	...
	var config = copyObj(linterOptions.paramsAllowed);
	config.rules["@gomarky/no-const-enum/no-export"][1].unused = "none";
	config.rules["@gomarky/no-const-enum/no-export"][1].count = 2;
	config.rules["@gomarky/no-const-enum/no-export"][1].length = 1;
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["z","w",];
...
QUnit.test( "PARAMS (allowed, count:2): violating", function test(assert){
	...
	config.rules["@gomarky/no-const-enum/no-export"][1].count = 2;
	config.rules["@gomarky/no-const-enum/no-export"][1].length = 1;
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["z",];
...
QUnit.test( "PARAMS (allowed, length:2): conforming", function test(assert){
	...
	config.rules["@gomarky/no-const-enum/no-export"][1].unused = "none";
	config.rules["@gomarky/no-const-enum/no-export"][1].count = 1000;
	config.rules["@gomarky/no-const-enum/no-export"][1].length = 2;
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["y","w",];
...
QUnit.test( "PARAMS (allowed, length:2): violating", function test(assert){
	...
	config.rules["@gomarky/no-const-enum/no-export"][1].count = 1000;
	config.rules["@gomarky/no-const-enum/no-export"][1].length = 2;
	config.rules["@gomarky/no-const-enum/no-export"][1].allowed = ["y",];
